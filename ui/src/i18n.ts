...
const en = {
    ...
    position: 'Position',
    pnl60: '60d sim',
    pnl60Title: 'Simulated DOW 30 portfolio over the last 60 sessions, from $1M cash (same curve for every ticker)',
    chat: 'FinGPT Agent',
...
const zh: Strings = {
    ...
    position: '持倉',
    pnl60: '60 日模擬',
    pnl60Title: '該 agent 對 DOW 30 整體組合的 60 日模擬（從 100 萬現金起算；每檔顯示同一條曲線）',
    chat: 'FinGPT 助理',
